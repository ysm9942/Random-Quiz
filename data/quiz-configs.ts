...
let quizConfigs: QuizConfig[] = [
  ...
  { id: "quiz-004", sourceImageId: "img-004", answer: "농루트", enabled: true, crop: { x: 582, y: 33, width: 330, height: 135 }, displayMaxWidth: 480, displayMaxHeight: 100, mask: { enabled: false, blurPercent: 0 }, updatedAt: "2026-04-03T03:14:48.997Z" },
  { id: "quiz-005", sourceImageId: "img-005", answer: "농루트", enabled: true, crop: { x: 855, y: 1696, width: 929, height: 685 }, displayMaxWidth: 480, displayMaxHeight: 220, mask: { enabled: false, blurPercent: 0 }, updatedAt: "2026-04-03T03:15:07.747Z" },
  { id: "quiz-006", sourceImageId: "img-006", answer: "농루트", enabled: true, crop: { x: 1240, y: 1456, width: 1104, height: 128 }, displayMaxWidth: 480, displayMaxHeight: 220, mask: { enabled: false, blurPercent: 0 }, updatedAt: "2026-04-03T03:15:26.291Z" },
  ...
  { id: "quiz-010", sourceImageId: "img-010", answer: "농루트", enabled: true, crop: { x: 5145, y: 2494, width: 1006, height: 694 }, displayMaxWidth: 480, displayMaxHeight: 220, mask: { enabled: false, blurPercent: 0 }, updatedAt: "2026-04-03T03:15:51.793Z" },
  { id: "quiz-011", sourceImageId: "img-011", answer: "농루트", enabled: true, crop: { x: 902, y: 773, width: 923, height: 224 }, displayMaxWidth: 480, displayMaxHeight: 220, mask: { enabled: false, blurPercent: 0 }, updatedAt: "2026-04-03T03:09:55.490Z" },
  ...
  { id: "quiz-015", sourceImageId: "img-015", answer: "쫀득", enabled: true, crop: { x: 890, y: 365, width: 1255, height: 861 }, displayMaxWidth: 480, displayMaxHeight: 220, mask: { enabled: false, blurPercent: 0 }, updatedAt: "2026-04-03T03:16:19.063Z" },
  ...
  { id: "quiz-017", sourceImageId: "img-017", answer: "쫀득", enabled: true, crop: { x: 1267, y: 1169, width: 680, height: 190 }, displayMaxWidth: 480, displayMaxHeight: 220, mask: { enabled: false, blurPercent: 0 }, updatedAt: "2026-04-03T03:16:48.811Z" },
  ...
  { id: "quiz-019", sourceImageId: "img-019", answer: "쫀득", enabled: true, crop: { x: 864, y: 132, width: 795, height: 703 }, displayMaxWidth: 480, displayMaxHeight: 220, mask: { enabled: false, blurPercent: 0 }, updatedAt: "2026-04-03T03:17:22.815Z" },
  { id: "quiz-020", sourceImageId: "img-020", answer: "쫀득", enabled: true, crop: { x: 640, y: 440, width: 794, height: 394 }, displayMaxWidth: 480, displayMaxHeight: 220, mask: { enabled: false, blurPercent: 0 }, updatedAt: "2026-04-03T03:17:32.469Z" },
  { id: "quiz-021", sourceImageId: "img-021", answer: "쫀득", enabled: true, crop: { x: 648, y: 353, width: 842, height: 712 }, displayMaxWidth: 480, displayMaxHeight: 220, mask: { enabled: false, blurPercent: 0 }, updatedAt: "2026-04-03T03:17:46.097Z" },
  ...
  { id: "quiz-024", sourceImageId: "img-024", answer: "쫀득", enabled: true, crop: { x: 590, y: 539, width: 279, height: 112 }, displayMaxWidth: 480, displayMaxHeight: 220, mask: { enabled: false, blurPercent: 0 }, updatedAt: "2026-04-03T03:10:58.942Z" },
];
