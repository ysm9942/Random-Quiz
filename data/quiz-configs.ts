...
let quizConfigs: QuizConfig[] = [
  ...
  { id: "quiz-006", sourceImageId: "img-006", answer: "농루트", enabled: true, crop: { x: 1480, y: 1240, width: 560, height: 176 }, displayMaxWidth: 480, displayMaxHeight: 220, mask: { enabled: false, blurPercent: 0 }, updatedAt: "2026-04-03T02:05:26.597Z" },
  ...
  { id: "quiz-008", sourceImageId: "img-008", answer: "농루트", enabled: true, crop: { x: 1056, y: 339, width: 123, height: 27 }, displayMaxWidth: 480, displayMaxHeight: 220, mask: { enabled: false, blurPercent: 0 }, updatedAt: "2026-04-03T02:45:43.588Z" },
  { id: "quiz-009", sourceImageId: "img-009", answer: "농루트", enabled: false, crop: { x: 1046, y: 2132, width: 311, height: 144 }, displayMaxWidth: 480, displayMaxHeight: 220, mask: { enabled: false, blurPercent: 0 }, updatedAt: "2026-04-03T02:45:27.595Z" },
  { id: "quiz-010", sourceImageId: "img-010", answer: "농루트", enabled: true, crop: { x: 3444, y: 1403, width: 850, height: 170 }, displayMaxWidth: 480, displayMaxHeight: 220, mask: { enabled: false, blurPercent: 0 }, updatedAt: "2026-04-03T02:45:57.516Z" },
  ...
  { id: "quiz-013", sourceImageId: "img-013", answer: "농루트", enabled: true, crop: { x: 576, y: 297, width: 171, height: 47 }, displayMaxWidth: 480, displayMaxHeight: 220, mask: { enabled: false, blurPercent: 0 }, updatedAt: "2026-04-03T02:46:55.612Z" },
  { id: "quiz-014", sourceImageId: "img-014", answer: "농루트", enabled: false, crop: { x: 0, y: 0, width: 500, height: 200 }, mask: { enabled: false, blurPercent: 0 }, updatedAt: "2026-04-03T02:46:49.720Z" },
  { id: "quiz-015", sourceImageId: "img-015", answer: "쫀득", enabled: true, crop: { x: 1328, y: 1065, width: 576, height: 95 }, displayMaxWidth: 480, displayMaxHeight: 220, mask: { enabled: false, blurPercent: 0 }, updatedAt: "2026-04-03T02:46:42.481Z" },
