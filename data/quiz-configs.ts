...
let quizConfigs: QuizConfig[] = [
  ...
  { id: "quiz-003", sourceImageId: "img-003", answer: "농루트", enabled: true, crop: { x: 323, y: 565, width: 358, height: 49 }, displayMaxWidth: 480, displayMaxHeight: 50, mask: { enabled: false, blurPercent: 0 }, updatedAt: "2026-04-03T03:07:37.133Z" },
  ...
  { id: "quiz-005", sourceImageId: "img-005", answer: "농루트", enabled: true, crop: { x: 773, y: 963, width: 929, height: 448 }, displayMaxWidth: 480, displayMaxHeight: 220, mask: { enabled: false, blurPercent: 0 }, updatedAt: "2026-04-03T03:06:32.275Z" },
  { id: "quiz-006", sourceImageId: "img-006", answer: "농루트", enabled: true, crop: { x: 1512, y: 1160, width: 584, height: 232 }, displayMaxWidth: 480, displayMaxHeight: 220, mask: { enabled: false, blurPercent: 0 }, updatedAt: "2026-04-03T03:06:49.287Z" },
  ...
  { id: "quiz-010", sourceImageId: "img-010", answer: "농루트", enabled: true, crop: { x: 5201, y: 2339, width: 836, height: 1035 }, displayMaxWidth: 480, displayMaxHeight: 220, mask: { enabled: false, blurPercent: 0 }, updatedAt: "2026-04-03T03:04:09.188Z" },
  ...
  { id: "quiz-015", sourceImageId: "img-015", answer: "쫀득", enabled: true, crop: { x: 1386, y: 1401, width: 496, height: 190 }, displayMaxWidth: 480, displayMaxHeight: 220, mask: { enabled: false, blurPercent: 0 }, updatedAt: "2026-04-03T03:08:22.054Z" },
  { id: "quiz-016", sourceImageId: "img-016", answer: "쫀득", enabled: true, crop: { x: 956, y: 657, width: 1073, height: 197 }, displayMaxWidth: 480, displayMaxHeight: 220, mask: { enabled: false, blurPercent: 0 }, updatedAt: "2026-04-03T03:10:35.683Z" },
  { id: "quiz-017", sourceImageId: "img-017", answer: "쫀득", enabled: true, crop: { x: 1394, y: 1037, width: 357, height: 386 }, displayMaxWidth: 480, displayMaxHeight: 220, mask: { enabled: false, blurPercent: 0 }, updatedAt: "2026-04-03T03:09:30.581Z" },
