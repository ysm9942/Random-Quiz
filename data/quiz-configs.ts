...
let quizConfigs: QuizConfig[] = [
  { id: "quiz-001", sourceImageId: "img-001", answer: "농루트", enabled: true, crop: { x: 427, y: 419, width: 109, height: 43 }, displayMaxWidth: 480, displayMaxHeight: 220, mask: { enabled: false, blurPercent: 0 }, updatedAt: "2026-04-03T02:58:00.863Z" },
  ...
  { id: "quiz-009", sourceImageId: "img-009", answer: "농루트", enabled: false, crop: { x: 1046, y: 2132, width: 311, height: 144 }, displayMaxWidth: 480, displayMaxHeight: 220, mask: { enabled: false, blurPercent: 0 }, updatedAt: "2026-04-03T02:56:50.821Z" },
  ...
  { id: "quiz-012", sourceImageId: "img-012", answer: "농루트", enabled: true, crop: { x: 1270, y: 1230, width: 407, height: 112 }, displayMaxWidth: 480, displayMaxHeight: 220, mask: { enabled: false, blurPercent: 0 }, updatedAt: "2026-04-03T02:59:23.200Z" },
  ...
  { id: "quiz-016", sourceImageId: "img-016", answer: "쫀득", enabled: true, crop: { x: 1014, y: 613, width: 948, height: 285 }, displayMaxWidth: 480, displayMaxHeight: 220, mask: { enabled: false, blurPercent: 0 }, updatedAt: "2026-04-03T02:57:13.065Z" },
